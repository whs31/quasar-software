...
uint16_t LPVL::crc16(char* data, int size) noexcept
{
    uint16_t crc = 0xFFFF;
...
uint16_t LPVL::crc16_ccitt(const char* data, int size) noexcept
{
...
char* LPVL::str_data(const QString& str) noexcept
{
