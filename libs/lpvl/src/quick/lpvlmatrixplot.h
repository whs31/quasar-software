...
namespace LPVL
{
    class LPVL_EXPORT MatrixPlot : public QQuickItem
    {
        ...
        public:
            ...
            float tintRed() const;
            void setTintRed(float other);

            float tintGreen() const;
            void setTintGreen(float other);

            float tintBlue() const;
            void setTintBlue(float other);

            float brightness() const;
            void setBrightness(float other);
