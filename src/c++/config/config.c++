...
Config::Config *Config::Config::get() { static Config instance; return &instance; }
...
QString Config::Config::projectVersion() { return PROJECT_VERSION; }
void Config::Config::sync() { ini->sync(); }
...
namespace Config {
  ...
  QString Config::remoteIP() const { return m_remoteIP; }
  ...
  QString Config::localIP() const { return m_localIP; }
  ...
  QString Config::telemetryPort() const { return m_telemetryPort; }
  ...
  QString Config::tcpLFSPort() const { return m_tcpLFSPort; }
  ...
  QString Config::udpLFSPort() const { return m_udpLFSPort; }
  ...
  QString Config::execdPort() const { return m_execdPort; }
  ...
  QString Config::feedbackPort() const { return m_feedbackPort; }
  ...
  bool Config::proxyEnabled() const { return m_proxyEnabled; }
  ...
  bool Config::antennaAlignment() const { return m_antennaAlignment; }
  ...
  float Config::angleCorrection() const { return m_angleCorrection; }
  ...
  bool Config::useRadians() const { return m_useRadians; }
  ...
  bool Config::useDriftAngle() const { return m_useDriftAngle; }
  ...
  float Config::thetaAzimuthCorrection() const { return m_thetaAzimuthCorrection; }
  ...
  double Config::storedLatitude() const { return m_storedLatitude; }
  ...
  double Config::storedLongitude() const { return m_storedLongitude; }
  ...
  double Config::storedZoomLevel() const { return m_storedZoomLevel; }
  ...
  QString Config::storedCatalogue() const { return m_storedCatalogue; }
  ...
  float Config::telemetryFrequency() const { return m_telemetryFrequency; }
  ...
  QString Config::tcpMarker() const { return m_tcpMarker; }
  ...
  QString Config::jetsonIP() const { return m_jetsonIP; }
  ...
  QString Config::navIP() const { return m_navIP; }
  ...
  QString Config::utl1IP() const { return m_utl1IP; }
  ...
  QString Config::utl2IP() const { return m_utl2IP; }
  ...
  QString Config::telemetryRecvPort() const { return m_telemetryRecvPort; }
