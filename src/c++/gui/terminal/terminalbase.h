...
namespace GUI
{
    class TerminalBase : public QAbstractListModel
    {
        ...
        public:
            ...
            TerminalBase(QObject* parent = nullptr);
            ...
            Q_INVOKABLE virtual void replaceLast(const QString& message, const QString& module = "", GUI::TerminalBase::MessageType type = Debug);
