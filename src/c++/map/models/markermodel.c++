  ...
  bool MarkerModel::setData(const QModelIndex& index, const QVariant& value, int role)
  {
    if(data(index, role) != value)
    {
      ...
      switch(role)
      {
        ...
        case Latitude: storage[index.row()].latitude = value.toDouble();
          break;
        case Longitude: storage[index.row()].longitude = value.toDouble();
          break;
        case MarkerName: storage[index.row()].name = value.toString();
          break;
        case MarkerColor: storage[index.row()].color = value.toString();
          break;
        case MarkerIcon: storage[index.row()].icon = value.toString();
          break;
