...
namespace Networking
{
  ...
  RemoteData::RemoteData(QObject* parent)
    : QObject{parent}, m_storageSpace(0), m_de10ping((int) Enums::PingStatus::Idle),
      m_jetsonping((int) Enums::PingStatus::Idle), m_navping((int) Enums::PingStatus::Idle),
      m_utl1ping((int) Enums::PingStatus::Idle), m_utl2ping((int) Enums::PingStatus::Idle)
  {}

  float RemoteData::storageSpace() const
  ...
  int RemoteData::jetsonping() const
  { return m_jetsonping; }
