...
namespace Utilities
{
    ...
    class Numeric : public QObject
    {
        ...
        public:
            ...
            static float degreesToKilometers(double degrees) noexcept(true);

            //! @brief  Конвертирует географические градусы в метры.
            //! @param      double degrees - градусы.
            //! @return     Расстояние в метрах.
            //! @warning    Не учитывает значение широты.
            static float degreesToMeters(double degrees) noexcept(true);

            //! @brief  Конвертирует километры в географические градусы.
            //! @param      float meters - метры.
            //! @return     Расстояние в географических градусах.
            //! @warning    Не учитывает значение широты.
            static double metersToDegrees(float meters) noexcept(true);
            ...
            static float mercatorZoomLevel(double latitude, float meters_per_px = 0) noexcept(true);
            ...
            static double zoomLevelToRatio(float zoom_level, double latitude = 0) noexcept(true);

            //! @brief  Переводит градусы в радианы.
            //! @param      float degrees - градусы.
            //! @return     Значение в радианах.
            static float degreesToRadians(float degrees) noexcept(true);

            //! @brief  Переводит радианы в градусы.
            //! @param      float radians - радианы.
            //! @return     Значение в градусах.
            static float radiansToDegrees(float radians) noexcept(true);
            ...
            static QPointF geoCoordToWebMercator(const QGeoCoordinate& point, uint8_t zoom = 19) noexcept(true);
    };
} // namespace Utilities;
